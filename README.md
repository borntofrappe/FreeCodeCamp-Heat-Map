...
The reference point included by the test suite indeed might not be able to fit with the coordinate system defined by a scaleBand. The ticks for the y-axis do line up with the rows, but they are positioned in the center of said rows.
